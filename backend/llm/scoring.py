            ...
            types.FunctionDeclaration(
                ...
                parameters=types.Schema(
                    ...
                    properties={
                        ...
                        "home_value": types.Schema(type="NUMBER", description="Optional estimated current home value; default 0"),
                        ...
                        "zip_code": types.Schema(type="STRING", description="Optional 5-digit ZIP code for tax lookup"),
                        "state": types.Schema(type="STRING", description="Optional two-letter state abbreviation"),
                        "pretax_401k": types.Schema(type="NUMBER", description="Optional annual 401k contribution; default 0"),
                        "pretax_ira": types.Schema(type="NUMBER", description="Optional annual traditional IRA contribution; default 0"),
                        "pretax_hsa": types.Schema(type="NUMBER", description="Optional annual HSA contribution; default 0"),
                        ...
                        "has_hsa_eligible_plan": types.Schema(type="BOOLEAN", description="Whether the user has an HSA-eligible plan"),
                        "hsa_coverage": types.Schema(type="STRING", enum=["self_only", "family"], description="Optional HSA coverage type"),
                        # Risk tolerance
...
def _draft_profile(seed: dict[str, Any], scores: dict) -> dict[str, Any]:
    ...
    draft: dict[str, Any] = {
        ...
        "home_value": _coerce_number(_pick(seed, "home_value")),
        "non_liquid_savings": _coerce_number(_pick(seed, "non_liquid_savings", "non_liquid_savings_amount")),
        ...
        "zip_code": _pick(seed, "zip_code", "zip"),
        "state": _pick(seed, "state"),
        "pretax_401k": _coerce_number(_pick(seed, "pretax_401k")),
        "pretax_ira": _coerce_number(_pick(seed, "pretax_ira")),
        "pretax_hsa": _coerce_number(_pick(seed, "pretax_hsa")),
        "employer_match_rate": _coerce_number(_pick(seed, "employer_match_rate")),
        "employer_match_cap_pct": _coerce_number(_pick(seed, "employer_match_cap_pct")),
        "has_hsa_eligible_plan": _pick(seed, "has_hsa_eligible_plan"),
        "hsa_coverage": _pick(seed, "hsa_coverage"),
